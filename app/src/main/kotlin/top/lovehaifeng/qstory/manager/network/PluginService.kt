package top.lovehaifeng.qstory.manager.network

import top.lovehaifeng.qstory.manager.data.OnlinePluginInfo
import top.lovehaifeng.qstory.manager.data.PaginatedScripts
import top.lovehaifeng.qstory.manager.data.AiReviewRecord
import top.lovehaifeng.qstory.manager.data.PlatformStatistics
import top.lovehaifeng.qstory.manager.data.QSResult
import top.lovehaifeng.qstory.manager.data.ScriptDetail
